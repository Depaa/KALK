...
public class sole extends data {
	...
	public void println(sole s) throws overflow_error {
		...
		System.out.println(
			"Il giorno " + s.getTime().getGiorno() + "/" + s.getTime().getMese() + "/" + s.getTime().getAnno() + System.getProperty("line.separator") +
		    "Sorgere: " + s.Sorgere() +	"Mezzogiorno Solare: " + s.mezzogiornoSolare() + System.getProperty("line.separator") +
		    "Tramonto: " + s.Tramonto() + System.getProperty("line.separator")
		);
	}
